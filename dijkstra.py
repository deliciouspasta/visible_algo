...
class dijkstraClass(TransitionRoutine):
    ...
    def dijkstra(self):
        ...
        while len(unsearchedNode) != 0:
            ...
            minIndex = self.get_min_index(tmpMinDis,distance,unsearchedNode)
    ...
    def get_min_index(self,tmpMinDis, distance, unsearchedNode):
        start = 0
        while True:
            index = distance.index(tmpMinDis, start)
            found = index in unsearchedNode
            if found:
                return index
            else:
                start = index + 1
    ...
    def print_graph_image(self):
        ...
        self.graph_img.node("1", color="blue")
        self.graph_img.node(str(self.nodeNum), color="blue")
