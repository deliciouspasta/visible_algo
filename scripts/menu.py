...
class FrameBase(tk.Tk):
    ...
    def change(self, frame):
        ...
        #self.StartPageFrame(self)=CleanUpRoutine(Applist[r][c][0])↓?
        #つまりはself.frame = CleanUpRoutine(Applist[r][c][0])ということ？↓
...
class StartPageFrame(tk.Frame):
    def __init__(self, master=None, **kwargs):
        ...
        self.Applist = [
                    [ [CleanUpRoutine, "Clean up routine"], [CleanUpRoutine, "Clean up routine"],[CleanUpRoutine, "Clean up routine"] ], 
                    [[CleanUpRoutine, "Clean up routine"],[CleanUpRoutine, "Clean up routine"],[CleanUpRoutine, "Clean up routine"] ]
                    ]
